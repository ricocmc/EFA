...
define('DB_NAME', 'efaacom_admin');

/** MySQL 資料庫使用者名稱，請更改 "username_here" */
define('DB_USER', 'efaacom_admin');

/** MySQL 資料庫密碼，請更改 "password_here" */
define('DB_PASSWORD', '52295590178894');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'u&0{U_j5+BO`[Z{+P?<h4X|jOQlr?8$8Q}^P.5r()I|HpV~~&:wI@I@vt)78==oN');
define('SECURE_AUTH_KEY',  '=8MS/q|z5(<O2zz(3:TZ9RUzB:Z+S;p0-:[}$SvloN.T||AiITgVB(7$1NtB$oF8');
define('LOGGED_IN_KEY',    'PO:AnI+)J&$EPV5+6|z$8Q#NPtF8{b;9+r61R,R?WouJ?6jXB};7Uq-h+BnfpZ-v');
define('NONCE_KEY',        '1;Gpl|JLfW$%G_G<e=.e/gN[kl^jzQ:7]O6/AVHq}Ifw-Qq~STUiC3,H% W}+FC$');
define('AUTH_SALT',        '[{50n-M|7swI_8(#;u(8|gAO0M8EC) a62_N|cq#h;OC,5PX? 7w?sRqVlw?&Zae');
define('SECURE_AUTH_SALT', 'f@VDMZ1Y,~]XE9:;g7Hb`S|}hYdw+vMd68+2iQ:oQ>i6|R>/w-N5b|q2W36=hHk4');
define('LOGGED_IN_SALT',   'K&AR91xB+{@!T&WF|.-^a0;IDIsZib5}9,XU!uzt/QYuF@J++Co}cH?l@~ISpE~t');
define('NONCE_SALT',       'ESCTn?$(QVsn:JL>G1ZI2,HqSpxpJ=RAL~c[<N*%ysW&PCUt|x=|O7A89@4))CkT');
